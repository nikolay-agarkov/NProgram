...
void KRModbusRTUSlaveRS485::_DO(){
  ...
  switch(mbDataBuffer[1]){
    ...
    case 0x04: 
      ...
      switch(len){
        case 1:
          ...
          mbDataBuffer[3]=reg16 >> 8;
          MBCRC(mbDataBuffer[3]);
          mbDataBuffer[4]=reg16;
        ...
        case 2:
          ...
          mbDataBuffer[5]=reg16 >> 8;
          MBCRC(mbDataBuffer[5]);
          mbDataBuffer[6]=reg16;
          MBCRC(mbDataBuffer[6]);
          break;
        default:
          prvBytes=3;
    ...
    case 0x10: 
      ...
      switch(len){
        case 1:
          reg16=mbDataBuffer[6]>0?mbDataBuffer[7]:0;
          reg16=(reg16 << 8) | (mbDataBuffer[6]>1?mbDataBuffer[8]:0);
          regs->write(index,reg16);
          break;
        case 2:
          reg16=mbDataBuffer[6]>0?mbDataBuffer[7]:0;
          reg16=(reg16 << 8) | (mbDataBuffer[6]>1?mbDataBuffer[8]:0);
          regs->write(index,reg16);
          reg16=mbDataBuffer[6]>2?mbDataBuffer[9]:0;
          reg16=(reg16 << 8) | (mbDataBuffer[6]>3?mbDataBuffer[10]:0);
