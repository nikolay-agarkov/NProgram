/*
  ...
  KRModbusASCIISlave.h
  Ver.: 1.0
  http://kandiral.ru/arduino/modbus_slave_na_arduino.html
    
*/

#ifndef KRMODBUSASCIISLAVE_H_
#define KRMODBUSASCIISLAVE_H_
...
class KRModbusASCIISlave : public KRModbusSlave{
  ...
  public:
    KRModbusASCIISlave(Stream &theSerial, KRRegisters &registers, uint8_t addr_):KRModbusSlave(theSerial, registers, addr_){
      bufascii[0]=58;
